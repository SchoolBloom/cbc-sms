...
export function LearnerProfileDialog({ learner, open, onOpenChange }: LearnerProfileDialogProps) {
      ...
      <DialogContent className="sm:max-w-[520px]">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-foreground">{learner.full_name}</p>
              <p className="text-sm text-muted-foreground">{learner.admission_number}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="font-medium text-foreground">{learner.assessment_number || "-"}</p>
            </div>
            <div>
              <p className="text-xs text-muted-foreground">UPI Number</p>
              <p className="font-medium text-foreground">{learner.upi_number || "-"}</p>
            </div>
            <div>
              <p className="text-xs text-muted-foreground">Birth Certificate No.</p>
              <p className="font-medium text-foreground">{learner.birth_certificate_number || "-"}</p>
            </div>
            <div>
              <p className="text-xs text-muted-foreground">Gender</p>
              <p className="font-medium text-foreground capitalize">{learner.gender}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-medium text-foreground">{learner.pathway || "-"}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-medium text-foreground">
                {new Date(learner.date_of_birth).toLocaleDateString("en-KE", {
                  year: "numeric",
                  month: "short",
                  day: "numeric",
                })}
